<?php
/**
 * Mobile_detect — CI3 Library Wrapper
 *
 * Source:  https://github.com/serbanghita/Mobile-Detect
 * Version: 3.74.4
 * License: MIT (https://github.com/serbanghita/Mobile-Detect/blob/master/LICENSE)
 * Author:  Serban Ghita <serbanghita@gmail.com> and contributors
 *
 * Modifications for CodeIgniter 3 compatibility:
 *   - Removed `namespace Detection;` declaration
 *   - Removed `use BadMethodCallException;` (class is in global namespace)
 *   - Renamed class `MobileDetect` → `Mobile_detect` to match CI3 library naming convention
 *
 * Usage:
