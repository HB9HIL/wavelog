...
class Logbookadvanced extends CI_Controller {
	...
	function index() {
		...
		$footerData['scripts_php'] = [
			'assets/js/sections/logbookadvanced.js.php',
			'assets/js/sections/logbookadvanced_edit.js.php',
			'assets/js/sections/logbookadvanced_map.js.php',
